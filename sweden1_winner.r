...
sweden1_b365_winners = get_b365_winner_odds("sweden1")
sweden1_uni_winners = get_uni_winner_odds("sweden1")
sweden1_bf_winners = get_bf_winner_odds("sweden1")
...
res_csl = sweden1_b365_winners %>% 
  ...
  merge(sweden1_bf_winners, by = c("selection_b365","market")) %>% 
  select(selection_b365, market, starts_with("odds")) %>% 
